...
public class EstrategiaNormalTest {
     ...
     public void estrategia1Elfo2Dwarves() {
         ...
         Dwarf d1 = new Dwarf();
         Dwarf d2 = new Dwarf();
         ArrayList<Dwarf> alvos = new ArrayList<Dwarf>(Arrays.asList(d1, d2));
     ...
     public void estrategia3Elfos2Dwarves() {
         ...
         exercito.atacar(alvos);
         // Assert
         assertEquals(new ArrayList<Elfo>(Arrays.asList(soldado3, soldado2, soldado1)), exercito.getOrdemDoUltimoAtaque()); 
         assertEquals(vidaEsperada, d1.getVida(), .0);
         assertEquals(vidaEsperada, d2.getVida(), .0);
     }
